...
// // Root route redirect to /register instead of /login
// app.get('/', (req, res) => {
...
//         const result = await sql.query`INSERT INTO AppUsers (username, email, password) VALUES (${username}, ${email}, ${hashedPassword})`;
//         res.redirect('/login');
//     } catch (err) {
//         console.error(err);
